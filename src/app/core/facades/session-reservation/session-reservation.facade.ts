...
export class SessionReservationFacade {
  ...
  loadInitialOptions(): Observable<ISessionReservationInitialOptions> {
    return forkJoin({
      products: this.reservationRead.getActiveBookingProducts(),
      systems: this.reservationRead.getActiveSystems(),
      gms: this.reservationRead.getVisibleGms(),
    }).pipe(
  ...
  loadCustomerEntitlements(
    ...
    return this.reservationRead.getCustomerEntitlements(customer).pipe(
      tap((entitlements) => {
  ...
  loadSystemsForSelectedGm(): Observable<ISystem[]> {
    ...
    return this.reservationRead.getSystemsForGm(gmId).pipe(
      tap((systems) => {
